...
/**
 * Create events providers based on the config/providers.json and client registrations
 * custom/starter-kit-registrations.json
 *
 * @param {object} clientRegistrations - Client registrations
 * @param {object} environment - Environment params
 * @param {string} accessToken - Access token
...
async function main(clientRegistrations, environment, accessToken) {
  ...
  try {
    ...
    const requiredRegistrations = Object.keys(providersEventsConfig);
    console.log('Client registrations', clientRegistrations);
    console.log('Required registrations', requiredRegistrations);
