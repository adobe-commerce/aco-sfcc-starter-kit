...
const EXTERNAL_EVENT_TYPE = 'sfcc.category.sync';
...
export function SyncCategoriesCard({ lastSync }) {
        ...
        <Flex direction="column" flex="1">
          <Heading level={3}>
            <Flex alignItems="center" gap="size-100">
              <DataUpload size="S" />
              <Text>Category Sync</Text>
            </Flex>
          </Heading>
          <Text>Synchronize all categories from SFCC to your ACO instance.</Text>
        </Flex>
