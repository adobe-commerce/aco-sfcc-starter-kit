...
const EXTERNAL_EVENT_TYPE = 'sfcc.full.sync';
...
export function FullSyncCard({ lastSync }) {
  ...
  return (
    <View paddingX="size-250" paddingBottom="size-250" borderRadius="medium" borderWidth="thin" borderColor="gray-300">
      ...
      <Text>
        Synchronize all products, price books, and prices from a given Salesforce Commerce Cloud site to your Adobe
        Commerce Optimizer instance.
      </Text>
