...
const EXTERNAL_EVENT_TYPE = 'sfcc.price-book.sync';
...
export function SyncPriceBooksCard({ lastSync }) {
        ...
        <Flex direction="column" flex="1">
          <Heading level={3}>
            <Flex alignItems="center" gap="size-100">
              <DataUpload size="S" />
              <Text>Price Book Sync</Text>
            </Flex>
          </Heading>
          <Text>Synchronize all price books from SFCC to your ACO instance.</Text>
        </Flex>
