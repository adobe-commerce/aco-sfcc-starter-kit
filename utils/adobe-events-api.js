 ...
 * @param {string | null} next Registrations url to get more data
 * @returns {Promise<Array>} Returns array of registrations
 ...
 * @param {object} environment Includes the needed parameters to call IO Event
 * @param {string} accessToken Adobe OAuth access token
 * @returns {Promise<Array>} Returns array of registrations with the name of the registration as key
 * @throws {Error} Throw exception in case the API call fails
 */
 ...
 * @returns {Promise<Array>} - Returns the list of providers
 */
...
/**
 * This method get the existing provider by its key, the key could be found on the file
 * (onboarding/config/providers.json)
 *
 ...
 * @returns {Promise<any>} Return IO Event provider
 */
