 ...
 *
 * @throws {Error} Error in case of failure, most likely when the app is not running in the Experience Cloud Shell.
 */
...
(function (e, t) {
  ...
  if (
    !/^(exc-unifiedcontent\.)?experience(-qa|-stage|-cdn|-cdn-stage)?\.adobe\.(com|net)$/.test(o.hostname) &&
    ...
    (n.onload = n.onreadystatechange =
      function () {
        (n.readyState && !/loaded|complete/.test(n.readyState)) ||
          ((n.onload = n.onreadystatechange = null), (n = void 0), 'EXC_MR_READY' in t && t.EXC_MR_READY());
      }),
