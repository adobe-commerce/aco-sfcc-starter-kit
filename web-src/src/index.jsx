...
function initialize(container) {
  ...
  const renderApp = () => {
    root.render(<App ims={appState.ims} theme={appState.theme} />);
  };
  ...
  try {
    ...
    init(() => {
      ...
      experienceCloudRuntime.on('ready', ({ imsOrg, imsToken, imsProfile, s2Theme }) => {
      ...
      experienceCloudRuntime.on('configuration', ({ imsOrg, imsToken, imsProfile, s2Theme }) => {
        const ims = {
          profile: imsProfile,
          org: imsOrg,
          token: imsToken,
      ...
      experienceCloudRuntime.title = 'ACO Sync Panel';
      experienceCloudRuntime.solution = {
        icon: 'AdobeExperienceCloud',
        title: 'ACO Sync Panel',
        shortTitle: 'ACO Sync Panel',
      };
    });
  } catch (_) {
